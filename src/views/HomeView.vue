<template>
     <div class="mobile-search">
      <form action="/" class="search-form">
         <img src="@/assets/images/svg/search.svg" alt="search" class="svg">
         ...
         <div class="navbar-left">
            <div class="logo-area">
               <a class="navbar-brand" href="index.html">
                  <img class="dark" src="@/assets/images/logo-dark.png" alt="logo">
                  <img class="light" src="@/assets/images/logo-white.png" alt="logo">
               </a>
               <a href="#" class="sidebar-toggle">
                  <img class="svg" src="@/assets/images/svg/align-center-alt.svg" alt="img"></a>
            </div>
            <div class="top-menu">
                           ...
                           <li>
                              <ul>
                                 <li class="has-subMenu-left">
                                    <a href="#" class="">
                                       <img src="@/assets/images/svg/mail.svg" alt="mail" class="svg nav-icon">
                                 ...
                                 <li>
                                    <a href="chat.html" class="">
                                       <img src="@/assets/images/svg/message-square.svg" alt="message-square" class="svg nav-icon">
                                 ...
                                 <li class="has-subMenu-left">
                                    <a href="#" class="">
                                       <img src="@/assets/images/svg/shopping-cart.svg" alt="shopping-cart" class="svg nav-icon">
                                 ...
                                 <li class="has-subMenu-left">
                                    <a href="#" class="">
                                       <img src="@/assets/images/svg/user-check.svg" alt="user-check" class="svg nav-icon">
                                 ...
                                 <li>
                                    <a href="chat.html" class="">
                                       <img src="@/assets/images/svg/bookmark.svg" alt="bookmark" class="svg nav-icon">
                                       <span class="menu-text">Note</span>
                                    </a>
                                 </li>
                                 <li>
                                    <a href="chat.html" class="">
                                       <img src="@/assets/images/svg/activity.svg" alt="activity" class="svg nav-icon">
                              ...
                              <ul>
                                 <li>
                                    <a href="kanban.html" class="">
                                       <img src="@/assets/images/svg/columns.svg" alt="columns" class="svg nav-icon">
                                       <span class="menu-text">Kanban Board</span>
                                    </a>
                                 </li>
                                 <li class="has-subMenu-left">
                                    <a href="#" class="">
                                       <img src="@/assets/images/svg/repeat.svg" alt="repeat" class="svg nav-icon">
                                 ...
                                 <li>
                                    <a href="file-manager.html" class="">
                                       <img src="@/assets/images/svg/file.svg" alt="file" class="svg nav-icon">
                                       <span class="menu-text">File Manager</span>
                                    </a>
                                 </li>
                                 <li>
                                    <a href="task-app.html" class="">
                                       <img src="@/assets/images/svg/clipboard.svg" alt="clipboard" class="svg nav-icon">
                                 ...
                                 <li class="has-subMenu-left">
                                    <a href="#" class="">
                                       <img src="@/assets/images/svg/user.svg" alt="user" class="svg nav-icon">
                        ...
                        <ul class="subMenu">
                           <li>
                              <a href="editors.html" class="">
                                 <img src="@/assets/images/svg/edit.svg" alt="svg" class="svg nav-icon">
                                 <span class="menu-text">Editors</span>
                              </a>
                           </li>
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="@/assets/images/svg/grid.svg" alt="grid" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="@/assets/images/svg/bar-chart-2.svg" alt="bar-chart-2" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="@/assets/images/svg/disc.svg" alt="disc" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="@/assets/images/svg/map.svg" alt="map" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="@/assets/images/svg/server.svg" alt="server" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="@/assets/images/svg/square.svg" alt="square" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="@/assets/images/svg/book.svg" alt="book" class="svg nav-icon">
         ...
         <div class="navbar-right">
            <ul class="navbar-right__menu">
               ...
               <li class="nav-message">
                  <div class="dropdown-custom">
                     <a href="javascript:;" class="nav-item-toggle icon-active">
                        <img class="svg" src="@/assets/images/svg/message.svg" alt="img">
                     </a>
               ...
               <li class="nav-notification">
                  <div class="dropdown-custom">
                     <a href="javascript:;" class="nav-item-toggle icon-active">
                        <img class="svg" src="@/assets/images/svg/alarm.svg" alt="img">
                     </a>
                     <div class="dropdown-parent-wrapper">
                        <div class="dropdown-wrapper">
                           ...
                           <ul>
                              <li class="nav-notification__single nav-notification__single--unread d-flex flex-wrap">
                                 <div class="nav-notification__type nav-notification__type--primary">
                                    <img class="svg" src="@/assets/images/svg/inbox.svg" alt="inbox">
                                 </div>
                              ...
                              <li class="nav-notification__single nav-notification__single--unread d-flex flex-wrap">
                                 <div class="nav-notification__type nav-notification__type--secondary">
                                    <img class="svg" src="@/assets/images/svg/upload.svg" alt="upload">
                                 </div>
                                 <div class="nav-notification__details">
                                    <p>
                                       <a href="" class="subject stretched-link text-truncate" style="max-width: 180px;">James</a>
                              ...
                              <li class="nav-notification__single nav-notification__single--unread d-flex flex-wrap">
                                 <div class="nav-notification__type nav-notification__type--success">
                                    <img class="svg" src="@/assets/images/svg/log-in.svg" alt="log-in">
                                 </div>
                                 <div class="nav-notification__details">
                                    <p>
                                       <a href="" class="subject stretched-link text-truncate" style="max-width: 180px;">James</a>
                              ...
                              <li class="nav-notification__single nav-notification__single d-flex flex-wrap">
                                 <div class="nav-notification__type nav-notification__type--info">
                                    <img class="svg" src="@/assets/images/svg/at-sign.svg" alt="at-sign">
                                 </div>
                                 <div class="nav-notification__details">
                                    <p>
                                       <a href="" class="subject stretched-link text-truncate" style="max-width: 180px;">James</a>
                              ...
                              <li class="nav-notification__single nav-notification__single d-flex flex-wrap">
                                 <div class="nav-notification__type nav-notification__type--danger">
                                    <img src="@/assets/images/svg/heart.svg" alt="heart" class="svg">
                                 </div>
                                 <div class="nav-notification__details">
                                    <p>
                                       <a href="" class="subject stretched-link text-truncate" style="max-width: 180px;">James</a>
                     ...
                     <div class="dropdown-parent-wrapper">
                        <div class="dropdown-wrapper dropdown-wrapper--large">
                           <ul class="list-settings">
                              <li class="d-flex">
                                 <div class="me-3"><img src="@/assets/images/mail.png" alt=""></div>
                              ...
                              <li class="d-flex">
                                 <div class="me-3"><img src="@/assets/images/color-palette.png" alt=""></div>
                                 <div class="flex-grow-1">
                                    <h6>
                              ...
                              <li class="d-flex">
                                 <div class="me-3"><img src="@/assets/images/home.png" alt=""></div>
                                 <div class="flex-grow-1">
                                    <h6>
                              ...
                              <li class="d-flex">
                                 <div class="me-3"><img src="@/assets/images/video-camera.png" alt=""></div>
                                 <div class="flex-grow-1">
                                    <h6>
                              ...
                              <li class="d-flex">
                                 <div class="me-3"><img src="@/assets/images/document.png" alt=""></div>
                                 <div class="flex-grow-1">
                                    <h6>
                              ...
                              <li class="d-flex">
                                 <div class="me-3"><img src="@/assets/images/microphone.png" alt=""></div>
                                 <div class="flex-grow-1">
                                    <h6>
               ...
               <li class="nav-flag-select">
                  <div class="dropdown-custom">
                     <a href="javascript:;" class="nav-item-toggle"><img src="@/assets/images/flag.png" alt="" class="rounded-circle"></a>
                     <div class="dropdown-parent-wrapper">
                        <div class="dropdown-wrapper dropdown-wrapper--small">
                           <a href=""><img src="@/assets/images/eng.png" alt=""> English</a>
                           <a href=""><img src="@/assets/images/ger.png" alt=""> German</a>
                           <a href=""><img src="@/assets/images/spa.png" alt=""> Spanish</a>
                           <a href=""><img src="@/assets/images/tur.png" alt=""> Turkish</a>
                           <a href=""><img src="@/assets/images/iraq.png" alt=""> Arabic</a>
                        </div>
                     </div>
               ...
               <li class="nav-author">
                  <div class="dropdown-custom">
                     <a href="javascript:;" class="nav-item-toggle"><img src="@/assets/images/author-nav.jpg" alt="" class="rounded-circle">
                        ...
                        <div class="dropdown-wrapper">
                           <div class="nav-author__info">
                              <div class="author-img">
                                 <img src="@/assets/images/author-nav.jpg" alt="" class="rounded-circle">
                              </div>
                              <div>
            ...
            <div class="navbar-right__mobileAction d-md-none">
               <a href="#" class="btn-search">
                  <img src="@/assets/images/svg/search.svg" alt="search" class="svg feather-search">
                  <img src="@/assets/images/svg/x.svg" alt="x" class="svg feather-x"></a>
               <a href="#" class="btn-author-action">
                  <img class="svg" src="@/assets/images/svg/more-vertical.svg" alt="more-vertical"></a>
            </div>
         </div>
         <!-- ends: .navbar-right -->
      </nav>
                     ...
                     <div class="card border-0 h-100">
                           ...
                           <div class="card-extra">
                              <div class="dropdown dropleft">
                                 <a href="#" role="button" id="else" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="@/assets/images/svg/more-horizontal.svg" alt="more-horizontal" class="svg">
                                 </a>
                        ...
                        <div class="card-body pt-0 pb-25 mt-n10">
                           <div class="label-detailed">
                              <div class="label-detailed__single"><span class="label-detailed__type label-detailed__type--primary">Orders</span> <strong class="label-detailed__total">$8,550</strong> <span class="label-detailed__status color-success"><img class="svg" src="@/assets/images/svg/arrow-success-up.svg" alt=""><strong>25%</strong></span> </div>
                              <div class="label-detailed__single"><span class="label-detailed__type label-detailed__type--info">Sales</span> <strong class="label-detailed__total">$5,550</strong> <span class="label-detailed__status color-danger"><img class="svg" src="@/assets/images/svg/arrow-danger-down.svg" alt=""> <strong>15%</strong></span> </div>
                           </div>
                           ...
                           <div class="tab-content">
                              <div class="tab-pane active show" id="salesgrowth" role="tabpanel" aria-labelledby="salesgrowth-tab">
                                 <div class="label-detailed label-detailed--two">
                                    <div class="label-detailed__single"><strong class="label-detailed__total">$8,550</strong> <span class="label-detailed__status color-success"><img class="svg" src="@/assets/images/svg/arrow-success-up.svg" alt=""> <strong>25%</strong></span> </div>
                                    <div class="label-detailed__single"><strong class="label-detailed__total">$5,550</strong> <span class="label-detailed__status color-danger"><img class="svg" src="@/assets/images/svg/arrow-danger-down.svg" alt=""> <strong>15%</strong></span> </div>
                                 </div>
                                       ...
                                       <table class="table table--default table-borderless">
                                          ...
                                          <tbody>
                                             <tr>
                                                <td>
                                                   <div class="selling-product-img d-flex align-items-center">
                                                      <img class="radius-xs img-fluid order-bg-opacity-primary" src="@/assets/images/premium-clock.png" alt="img">
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="selling-product-img d-flex align-items-center">
                                                      <img class="radius-xs img-fluid order-bg-opacity-primary" src="@/assets/images/t-shirt.png" alt="img">
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="selling-product-img d-flex align-items-center">
                                                      <img class="radius-xs img-fluid order-bg-opacity-primary" src="@/assets/images/nike.png" alt="img">
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="selling-product-img d-flex align-items-center">
                                                      <img class="radius-xs img-fluid order-bg-opacity-primary" src="@/assets/images/cup-glass.png" alt="img">
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="selling-product-img d-flex align-items-center">
                                                      <img class="radius-xs img-fluid order-bg-opacity-primary" src="@/assets/images/women-bag.png" alt="img">
                                                      <span>Women Bag</span>
                                                   </div>
                                                </td>
                                                <td>$32</td>
                                       ...
                                       <table class="table table--default table-borderless">
                                          ...
                                          <tbody>
                                             <tr>
                                                <td>
                                                   <div class="selling-product-img d-flex align-items-center">
                                                      <img class="me-15 wh-34 img-fluid order-bg-opacity-primary" src="@/assets/images/287.png" alt="img">
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="selling-product-img d-flex align-items-center">
                                                      <img class="me-15 wh-34 img-fluid" src="@/assets/images/165.png" alt="img">
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="selling-product-img d-flex align-items-center">
                                                      <img class="me-15 wh-34 img-fluid order-bg-opacity-primary" src="@/assets/images/166.png" alt="img">
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="selling-product-img d-flex align-items-center">
                                                      <img class="me-15 wh-34 img-fluid order-bg-opacity-primary" src="@/assets/images/315.png" alt="img">
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="selling-product-img d-flex align-items-center">
                                                      <img class="me-15 wh-34 img-fluid order-bg-opacity-primary" src="@/assets/images/506.png" alt="img">
